...
import {getPayer, getRpcUrl, createKeypairFromFile, newAccountWithLamports} from './utils';
...
sampleGreeter.txt = '0000000000000';
...
export async function establishPayer(): Promise<void> {
  ...
  if (!payer) {
    ...
    console.log('call newAccountWithLamports');
  }
